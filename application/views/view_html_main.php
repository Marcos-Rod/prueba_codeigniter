        ...
        <div class="col">
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <a type="button" href="users/create" class="w-100 btn btn-lg btn-outline-primary">Agregar Usuarios</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <a href="users" type="button" class="w-100 btn btn-lg btn-primary">Ver Reportes</a>
                </div>
            </div>
        </div>
    </div>
